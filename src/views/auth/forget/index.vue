  ...
  <div class="login-panel">
    <n-form class="form">
      <div class="flex-column">
        <label>手机号</label></div>
      <div class="inputForm">
        <SvgIcon size="small" name="ali-phone"/>
        <n-input placeholder="手机号" class="input" type="text"></n-input>
      </div>
      <div class="flex-column">
        <label>密码 </label></div>
      <div class="inputForm">
        <SvgIcon size="small" name="ali-password"/>
        <n-input placeholder="请输入密码" class="input" type="password"></n-input>
      </div>
      <div class="flex-column">
        <label>重复密码 </label></div>
      <div class="inputForm">
        <SvgIcon size="small" name="ali-repassword"/>
        <n-input placeholder="请再次输入密码" class="input" type="password"></n-input>
      </div>
      <div class="flex-column">
        <label>验证码 </label></div>
      <div class="inputForm">
      ...
      <p class="p">想起来了? <span class="span" @click="routeTo('/auth/login')">登录</span>
      </p>
    </n-form>
  </div>
</template>
